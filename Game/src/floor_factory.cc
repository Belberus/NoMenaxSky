...
std::unordered_map<std::string, std::unique_ptr<Floor::Room>> FloorFactory::ParseRooms3D(const tmx::Map &map, const std::string &layer_name,
...
void FloorFactory::ParseRoomContents3D(
    const tmx::Map &map, const tmx::ObjectGroup &object_layer,
    const std::shared_ptr<EntityFactory3D> &factory, Floor::Room &room, const std::string &level) {
